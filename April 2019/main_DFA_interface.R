...
# Example 10.4: close to noise (typical for log-returns of FX-data)
a1<--0.08
b1<-0.0
true_model_order<-c(1,0,0)
...
#---------------------------------------------------------------------------------------
# Example 11: Comparison of DFA-dft and DFA based on Burg's maximum entropy spectral estimate
